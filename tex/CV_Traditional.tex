...
\usepackage{amssymb, multicol, graphicx, hyperref, lipsum}
\hypersetup{
	pdftitle={Resume},
	pdfsubject={Resume},
	pdfauthor={Mark Kim}
...
\hrulefill{\fontsize{14}{14}\selectfont \textbf{\ \ Research \& Fellowships\ \ }}\hrulefill
...
of confusion matrices, accuracy, F1-score, and ROC/AUC.
	% \makeatletter
...
\hrulefill{\fontsize{14}{14}\selectfont \textbf{\ \ Organizations \& Leadership\ \ }}\hrulefill
...
\begin{tikzpicture}[overlay,remember picture]
	...
	\node [draw=none] at (14.95,-7.4) {\fontsize{23}{23}\selectfont
	\textbf{Mark S. Kim}};
\end{tikzpicture}
