...
\vspace{\contentblockspacing}
\vspace*{-6mm} % contentblockspacing adjustment
\begin{minipage}[ct]{\contentwidth}
...
\vspace{\contentblockspacing}
\vspace{-0.5mm} % contentblockspacing adjustment
\begin{minipage}[ct]{\contentwidth}
...
% \begin{minipage}[ct]{0.9\linewidth}
%     \textsc{Languages: } Python, Java, C/C++, JavaScript, HTML, CSS, R, Matlab

%     \vspace{1.5mm}

%     \textsc{Database Systems: } MongoDB, SQL
